...
CMD echo "EL USUARIO ES ${POSTGRES_USER}!"

RUN echo "create-jdbc-connection-pool --datasourceclassname org.postgresql.ds.PGSimpleDataSource --property user=POSTGRES_USER:password=POSTGRES_PASS:serverName=db:portNumber=5432:databaseName=POSTGRES_DB_NAME baches-pool" >> $PREBOOT_COMMANDS \
